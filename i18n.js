const translations = {
    'pt': {
        ...
        'ai_provider_groq': 'Groq Cloud (Llama 3)',
        'ai_provider_pollinations': 'Pollinations.ai (Grátis - Sem Chave)',
        'ai_model_label': 'Modelo',
        'ai_api_key_groq_label': 'Chave da API (Groq)',
        'ai_api_key_groq_placeholder': 'Cole sua chave aqui (gsk_...)',
        'ai_api_key_groq_help': 'Obtenha gratuitamente em: ',
    ...
    'en': {
        ...
        'ai_api_key_groq_label': 'API Key (Groq)',
        'ai_api_key_groq_placeholder': 'Paste your key here (gsk_...)',
        'ai_api_key_groq_help': 'Get it for free at: ',
        'ai_model_gpt4o': 'GPT-4o',
        'ai_model_claude': 'Claude 3.5 Sonnet',

...
async def main():
    async with async_playwright() as p:
        ...
        # 2. Abrir a janela de chat para confirmar que o bug foi corrigido
        ...
        # 3. Tirar screenshot para verificação visual
        await page.screenshot(path="assistant_final_fix_and_layout.png")

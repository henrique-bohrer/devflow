...
# Replace duplicate search logic accurately
content = re.sub(r'// --- LÓGICA DE PESQUISA DE RÁDIO E ARTISTAS ---[\s\S]*?// --- INICIALIZAÇÃO GERAL ---', '// --- INICIALIZAÇÃO GERAL ---', content)
# We might still have one more if it duplicated exactly, so replace all
content = re.sub(r'// --- LÓGICA DE PESQUISA DE RÁDIO E ARTISTAS ---[\s\S]*?// --- INICIALIZAÇÃO GERAL ---', '// --- INICIALIZAÇÃO GERAL ---', content)

search_logic = """// --- LÓGICA DE PESQUISA DE RÁDIO E ARTISTAS ---
...
content = content.replace('// --- INICIALIZAÇÃO GERAL ---', search_logic, 1)
